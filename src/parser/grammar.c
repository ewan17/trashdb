...
#define YY_MIN_REDUCE        16
#define YY_MAX_REDUCE        20
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    14,    3,    8,   10,   11,    1,    2,    9,   20,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     5,    6,    2,    3,    4,    1,    7,    2,    0,    8,
 /*    10 */     8,    8,    8,    8,
};
...
static const YYCODETYPE yyRuleInfoLhs[] = {
     6,  /* (0) obj ::= LBRACE RBRACE */
     6,  /* (1) obj ::= LBRACE data RBRACE */
     7,  /* (2) data ::= NUM */
     7,  /* (3) data ::= STRING */
     5,  /* (4) prog ::= obj */
};
...
static const signed char yyRuleInfoNRhs[] = {
   -2,  /* (0) obj ::= LBRACE RBRACE */
   -3,  /* (1) obj ::= LBRACE data RBRACE */
   -1,  /* (2) data ::= NUM */
   -1,  /* (3) data ::= STRING */
   -1,  /* (4) prog ::= obj */
};
...
#line 30 "grammar.y"
{
                                            yymsp[0].minor.yy0.s = "string";
                                        }
#line 869 "grammar.c"
        break;
      default:
      /* (4) prog ::= obj */ yytestcase(yyruleno==4);
        break;
/********** End reduce actions ************************************************/
  };
